...
namespace Hairology
{
    public class DatabaseQueries
    {
        ...
        public const string SELECT_EMPLOYEE_DETAILS = "SELECT first_name, last_name, age, sex, address_line_1, address_line_2, county, post_code FROM [Employee Details] WHERE employee_number = '{0}'";
